...
const Footer = () => {
	...
	return (
		<footer className="flex flex-col items-center justify-center gap-2 max-w-7xl mx-auto w-full mb-8  px-4 ">
			<h1 className="text-[13vw] font-extrabold text-transparent h-full text-center leading-none select-none bg-clip-text bg-linear-to-t from-neutral-800 to-neutral-200 opacity-40 mask-b-from-65% mask-b-to-95%">
				SecondBrain
			</h1>
